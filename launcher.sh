...
# extract update_products -> faz a extração de todos os produtos da pagina atual
# extract update_pages -> atualiza os produtos pela pagina do produto
...
# python3 main.py darkness extract --option update_products # concertar
# python3 main.py darkness dry --option init
python3 main.py darkness ingestion
# python3 main.py _compiled_supplement_ ingestion
