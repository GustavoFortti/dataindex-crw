...
CONF = {
    ...
    "brand": "bold snacks",
    "product_desc_tag_loc": [{'tag': 'div', 'class': 'product__description'}],
    "data_path" : f"{LOCAL}/data/supplement/brazil/boldsnacks",
    "seed_path": f"{LOCAL}/pages/supplement/brazil/boldsnacks",
