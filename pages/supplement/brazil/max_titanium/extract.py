...
def get_product_link(soup, map_type):
    if (map_type == "seed"):
        ...
        product_link =  "https://www.maxtitanium.com.br" +  product_link_element['href'] if product_link_element else None
        return product_link
    # map_tree
    return None
...
map_seed_conf = {
    ...
    "time_sleep_page": 3,
    "scroll_page": [{"time_sleep": 0.9, "size_height": 500}, {"time_sleep": 0.3, "size_height": 200}],
    "return_text": False,
}
